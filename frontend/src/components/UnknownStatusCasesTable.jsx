...
const UnknownStatusCasesTable = ({ data }) => {
  if (!data || data.length === 0) {
    return (
      ...
      >
        ...
        <p style={{ color: "#666", marginTop: "10px", fontSize: "13px" }}>No cases with unknown status available</p>
      </div>
    );
  }
...
export default UnknownStatusCasesTable;